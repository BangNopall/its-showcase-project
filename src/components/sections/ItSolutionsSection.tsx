...
function Counter({ value, suffix = "", duration = 1.5 }: { value: number; suffix?: string; duration?: number }) {
  ...
  return <span ref={ref} className="font-heading font-bold">{count}{suffix}</span>;
}
...
const divisionCards = [
  {
    ...
    desc: "Membangun dan merawat platform web utama sebagai pusat informasi digital."
  },
  {
    icon: Palette,
    name: "UI/UX Design",
  ...
  },
  {
    ...
    desc: "Mengeksplorasi dan meluncurkan solusi digital baru untuk kemajuan BEM."
  }
];
...
const keyResults = [
  { value: 90, suffix: "%", label: "Project Selesai Tepat Waktu", desc: "Komitmen ketat pada timeline pengembangan demi keandalan organisasi." },
  { value: 2, suffix: "+", label: "Solusi Digital Baru", desc: "Produk aplikasi pendukung yang dikembangkan khusus bagi mahasiswa." },
  { value: 1, suffix: "", label: "Proyek Eksternal Selesai", desc: "Kemitraan strategis pembuatan website yang sukses dituntaskan." }
];
...
const programs = [
  {
    ...
    goals: [
      "Menyampaikan informasi BEM FILKOM secara resmi",
  ...
  },
  {
    ...
    title: "BEM APPS",
    icon: Smartphone,
    desc: "Ekosistem aplikasi digital BEM FILKOM untuk mendukung pelayanan mahasiswa secara terintegrasi.",
    apps: [
      { name: "SIPERAT", detail: "Sistem Pengajuan Surat Online" },
      { name: "SJW FILKOM", detail: "Platform Pencegahan Kekerasaan Seksual" },
      { name: "ADVOSIAGA", detail: "Portal Layanan Advokasi Mahasiswa" },
      { name: "MOTION", detail: "Sistem Monitoring & Evaluasi Anggota" },
      { name: "FILAFEST", detail: "Platform Voting & Awarding BEM" },
  ...
  },
  {
    ...
    goals: [
      ...
      "Mendukung pendanaan mandiri organisasi"
    ]
  }
];
...
const waterfallSteps = [
  ...
  },
  {
    ...
    title: "Testing",
    icon: CheckCircle2,
    desc: "Pengujian kualitas perangkat lunak secara menyeluruh untuk memastikan bebas dari bug."
  },
  {
    step: "05",
    title: "Deployment",
...
// ==========================================
// 2. VISI DAN MISI SECTION
// ==========================================
export function ItVisiMisiSection() {
  return (
    <AnimatedSection
      id="it-visi-misi"
    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl">
        <SectionHeader
          eyebrow="Visi & Tujuan"
          title="Visi dan Tujuan IT Solutions"
          description="Tujuan strategis biro dalam memperkuat infrastruktur informasi organisasi dan metrik pencapaian hasil kerja."
          theme="light"
          align="center"
        />
        ...
        <div className="mt-16 space-y-12">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="relative overflow-hidden rounded-[30px] card-surface card-light p-8 md:p-10 shadow-lg backdrop-blur-md border-[rgba(var(--primary-900-rgb),0.12)]"
          >
            <div className="absolute top-0 right-0 w-[300px] h-[300px] bg-[rgba(var(--primary-900-rgb),0.04)] rounded-full blur-[80px] pointer-events-none" />
            <div className="flex flex-col md:flex-row gap-6 md:items-start relative z-10">
              <div className="inline-flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-[rgba(var(--primary-900-rgb),0.08)] text-[var(--primary-900)] shadow-[0_0_20px_rgba(31,103,120,0.06)]">
                <Target className="h-7 w-7" />
              </div>
              <div className="space-y-4">
                <h4 className="font-heading text-sm font-bold tracking-widest text-[var(--primary-900)] uppercase">Objective Utama</h4>
                <blockquote className="font-heading text-xl md:text-2xl font-medium text-[var(--text-default)] leading-relaxed italic">
                  &ldquo;Meningkatkan kehadiran digital dan infrastruktur teknologi informasi SGE dengan memperkuat peran website sebagai pusat informasi utama serta mendukung kebutuhan teknologi seluruh program kerja.&rdquo;
                </blockquote>
              </div>
            </div>
          </motion.div>

          {/* Key Results Timeline-Style Layout */}
          <div className="grid gap-6 md:grid-cols-3 relative">
            {/* Connector line for large screens */}
            <div className="hidden md:block absolute top-[44px] left-[15%] right-[15%] h-[1px] bg-[linear-gradient(90deg, rgba(31,103,120,0.06), rgba(242,183,5,0.04), rgba(31,103,120,0.06))] pointer-events-none z-0" />
            ...
            {keyResults.map((kr, index) => (
              ...
              >
                ...
                <h4 className="font-heading text-lg font-medium text-[var(--text-default)] mb-2">{kr.label}</h4>
                <p className="text-xs text-[var(--text-muted)] leading-5 max-w-[280px]">{kr.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          <div className="space-y-4">
            ...
            <p className="text-sm text-[var(--text-muted)] max-w-xl">
              Daftar program kerja taktis untuk menghadirkan ekosistem layanan digital BEM FILKOM UB secara andal dan komprehensif.
            </p>
          </div>
          ...
          <div className="flex gap-2 self-start md:self-auto">
            <button
              ...
              className={cn(
                ...
                canScrollLeft ? "hover:bg-[var(--bg-card)] active:scale-95" : "opacity-40 cursor-not-allowed"
              )}
            ...
            <button
              ...
              className={cn(
                "flex h-11 w-11 items-center justify-center rounded-full border bg-[var(--bg-surface)] text-[var(--text-default)] transition-all border-[rgba(var(--primary-900-rgb),0.16)]",
                canScrollRight ? "hover:bg-[var(--bg-card)] active:scale-95" : "opacity-40 cursor-not-allowed"
              )}
            ...
            return (
              ...
              >
                {/* Header */}
                  ...
                  <p className="text-sm text-[var(--text-muted)] leading-relaxed">{prog.desc}</p>
                </div>
                ...
                <div className="my-6 border-t border-b border-[var(--card-border)] py-5 space-y-4 flex-1">
                  ...
                  {prog.id === "maintenance" && prog.features && prog.goals && (
                    <div className="space-y-4">
                      <div>
                        <span className="text-xs font-bold text-[var(--accent-500)] block mb-2 uppercase">Fitur Visual</span>
                        <div className="flex flex-wrap gap-2">
                          {prog.features.map((f) => (
                            <span key={f} className="text-xs bg-[var(--bg-card)] border-[var(--card-border)] px-3 py-1.5 rounded-full font-medium text-[var(--text-muted)]">
                              {f}
                            </span>
                          ))}
                        </div>
                  ...
                  {prog.id === "bem-apps" && prog.apps && prog.flow && (
                    <div className="space-y-5">
                      <div>
                        <span className="text-xs font-bold text-[var(--accent-500)] block mb-2 uppercase">Showcase Ekosistem</span>
                        ...
                        <div className="relative flex justify-between items-center rounded-2xl bg-[var(--bg-card)] border-[var(--card-border)] p-3">
                          ...
                          <div className="absolute top-[31px] left-[15%] right-[15%] h-[2px] bg-[rgba(0,0,0,0.04)] z-0">
                            <motion.div
                              ...
                              style={{ position: "absolute", background: "linear-gradient(90deg,var(--primary-200),var(--primary-500))" }}
                            />
                          </div>
                        </div>
                      </div>
                  ...
                  {prog.id === "event-request" && prog.workflow && prog.examples && (
                    <div className="space-y-4">
                      <div>
                        <span className="text-xs font-bold text-[var(--accent-500)] block mb-2 uppercase">Workflow Pembuatan</span>
                        <div className="grid grid-cols-2 gap-2">
                  ...
                  {prog.id === "partnership" && prog.benefits && prog.goals && (
                    <div className="space-y-4">
                      <div>
                        <span className="text-xs font-bold text-[var(--accent-500)] block mb-2 uppercase">Layanan Kemitraan</span>
                        <div className="grid grid-cols-2 gap-2">
                          {prog.benefits.map((b) => (
                            <div key={b} className="flex items-center gap-2 px-2.5 py-2 rounded-xl border-[var(--card-border)] bg-[var(--bg-card)]">
                              <span className="h-1.5 w-1.5 rounded-full bg-[var(--primary-900)]" />
                              <span className="text-[11px] font-bold text-[var(--text-muted)] leading-tight">{b}</span>
                            </div>
                          ))}
                        </div>
                      </div>
    ...
    <AnimatedSection id="it-workflow" className="bg-[var(--bg-surface)] text-[var(--text-default)] scroll-mt-20">
      ...
      <div className="relative mx-auto max-w-7xl">
        <SectionHeader
          ...
          description="Metodologi rekayasa perangkat lunak terstruktur yang diterapkan oleh IT Solutions BEM FILKOM UB."
          theme="light"
          align="center"
        />
        ...
        <div className="mt-16 space-y-12">
          ...
          >
            <div className="flex gap-4 items-start">
              ...
              <div className="space-y-1.5">
                <h4 className="font-heading text-base font-medium text-[var(--text-default)]">Waterfall Development Methodology</h4>
                <p className="text-xs leading-6 text-[var(--text-muted)]">
                  Seluruh proyek IT Solutions dikembangkan menggunakan metode **Waterfall Development**. Metodologi terstruktur ini 
                  memastikan analisis kebutuhan terdokumentasi lengkap, arsitektur sistem matang sebelum kode ditulis, dan jaminan testing 
                  berkualitas tinggi guna memberikan stabilitas operasional pada seluruh ekosistem digital BEM FILKOM.
                </p>
              </div>
            </div>
          </motion.div>
